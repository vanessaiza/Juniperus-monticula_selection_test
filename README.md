# _Juniperus monticola_ selection test
This repository contains the data and the scripts to perform the analysis of **Bayescan** and **LFMM** to detect candidate loci under natural selection, suggestive for local adaptation in populations of _Juniperus monticola_ downloaded from the article:
...
The file "Summary.html" contains information about the proyect of this repository
